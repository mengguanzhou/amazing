...
package com.wiipu.shopping.barcode.camera;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = 500;// 初始值是 240
	private static final int MIN_FRAME_HEIGHT = 500;// 初始值是 240
	private static final int MAX_FRAME_WIDTH = 700;// 初始值是 480
	private static final int MAX_FRAME_HEIGHT = 600;// 初始值是 360
